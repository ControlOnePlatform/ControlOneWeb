...
<main class="scroll-smooth bg-gray-50">
    ...
    <section class="relative bg-primary h-[350px] flex items-center justify-center text-center shadow-lg">
        <div class="absolute inset-0 z-0">
            <img src="/assets/img/blog/bodega-control-one-sellos-seguridad.avif" 
    ...
    <nav class="sticky top-0 z-50 bg-white/95 backdrop-blur shadow-sm border-b border-gray-200">
        <div class="container mx-auto px-4">
            <div id="product-nav" class="flex overflow-x-auto gap-4 py-3 no-scrollbar justify-start md:justify-center text-sm">
                ...
                <a href="#gps" data-target="gps" class="whitespace-nowrap font-bold text-white bg-emerald-600 hover:bg-emerald-700 transition-colors px-4 py-1 rounded-full shadow-sm hover:shadow-md flex items-center gap-1 scroll-link">📡 GPS</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md border-2 border-transparent hover:border-accent hover:shadow-2xl transition-all duration-300 group flex flex-col md:flex-row overflow-hidden">
                    <div class="md:w-2/5 h-64 md:h-auto bg-gray-50 flex items-center justify-center p-4 relative">
                        ...
                        <img src="/assets/img/sellos/sello-seguridad-star-one-indicativo.avif" alt="Sello de botella Star One ISO 17712 alta seguridad" class="h-4/5 object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" loading="lazy">
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-md border-2 border-transparent hover:border-accent hover:shadow-2xl transition-all duration-300 group flex flex-col md:flex-row overflow-hidden">
                    <div class="md:w-2/5 h-64 md:h-auto bg-gray-50 flex items-center justify-center p-4 relative">
                        ...
                        <img src="/assets/img/sellos/sello-tipo-cable-c-one316.avif" alt="Sello de cable de acero C-ONE 316 ISO 17712 para tráileres" class="h-4/5 object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" loading="lazy">
                    </div>
                    <div class="p-6 md:w-3/5 flex flex-col">
                 ...
                 <div class="bg-white rounded-xl shadow-md border-2 border-transparent hover:border-accent hover:shadow-2xl transition-all duration-300 group flex flex-col md:flex-row overflow-hidden">
                    <div class="md:w-2/5 h-64 md:h-auto bg-gray-50 flex items-center justify-center p-4">
                        <img src="/assets/img/sellos/sello-c-one-180.avif" alt="Sello de cable C-ONE 180 galvanizado 3.2mm" class="h-4/5 object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" loading="lazy">
                    </div>
                    <div class="p-6 md:w-3/5 flex flex-col">
                ...
                <!-- C-BLOCK -->
                 <div class="bg-white rounded-xl shadow-md border-2 border-transparent hover:border-accent hover:shadow-2xl transition-all duration-300 group flex flex-col md:flex-row overflow-hidden">
                    <div class="md:w-2/5 h-64 md:h-auto bg-gray-50 flex items-center justify-center p-4 relative">
                        ...
                        <img src="/assets/img/sellos/sello-c-block.avif" alt="Sello C-BLOCK cable inoxidable grado marino anticorrosión" class="h-4/5 object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" loading="lazy">
                    </div>
                    <div class="p-6 md:w-3/5 flex flex-col">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5 hover:border-accent hover:shadow-xl transition-all duration-300 group flex flex-col">
                    <div class="h-48 flex justify-center items-center bg-gray-50 rounded-lg mb-4 p-4">
                        <img src="/assets/img/sellos/sello-tipo-cable-c-onex6.avif" class="h-full object-contain mix-blend-multiply group-hover:scale-110 transition-transform" alt="Sello de cable fino C-ONE X6 para válvulas" loading="lazy">
                    </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5 hover:border-accent hover:shadow-xl transition-all duration-300 group flex flex-col">
                    <div class="h-48 flex justify-center items-center bg-gray-50 rounded-lg mb-4 p-4">
                        <img src="/assets/img/sellos/sello-tipo-cable-c-one116.avif" class="h-full object-contain mix-blend-multiply group-hover:scale-110 transition-transform" alt="Sello de cable C-ONE 116 cuerpo aluminio" loading="lazy">
                    </div>
                    <div class="flex-grow text-center">
                 ...
                 <div class="bg-white rounded-xl border border-gray-200 p-5 hover:border-accent hover:shadow-xl transition-all duration-300 group flex flex-col">
                    <div class="h-48 flex justify-center items-center bg-gray-50 rounded-lg mb-4 p-4 relative">
                        ...
                        <img src="/assets/img/sellos/sello-rotaseal.avif" class="h-full object-contain mix-blend-multiply group-hover:scale-110 transition-transform" alt="Sello Rotaseal para medidores de luz y agua" loading="lazy">
                    </div>
                    <div class="flex-grow text-center">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:border-accent hover:shadow-lg transition-all flex flex-col items-center text-center group">
                    <img src="/assets/img/sellos/precinto-plastico-quantum-ajustable.avif" class="h-32 mb-4 object-contain group-hover:-translate-y-1 transition-transform" alt="Precinto plástico Quantum ajustable con inserto metálico" loading="lazy">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:border-accent hover:shadow-lg transition-all flex flex-col items-center text-center group">
                    <img src="/assets/img/sellos/sello-plastico-quamtum-r-12.avif" class="h-32 mb-4 object-contain group-hover:-translate-y-1 transition-transform" alt="Precinto plástico Quantum R12 tipo cola de rata" loading="lazy">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:border-accent hover:shadow-lg transition-all flex flex-col items-center text-center group">
                    <img src="/assets/img/sellos/sello-alli-one-anillo.avif" class="h-32 mb-4 object-contain group-hover:-translate-y-1 transition-transform" alt="Sello plástico Alli-One de anillo fijo" loading="lazy">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:border-accent hover:shadow-lg transition-all flex flex-col items-center text-center group">
                    <img src="/assets/img/sellos/sello-jumbo-seal-paleta-grande.avif" class="h-32 mb-4 object-contain group-hover:-translate-y-1 transition-transform" alt="Sello Jumbo Seal plástico paleta grande para logística" loading="lazy">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-gray-200 border-t border-gray-200">
        <section id="etiquetas" class="bg-white py-16 px-8 hover:bg-red-50 transition-colors group scroll-mt-20">
            <div class="flex items-center gap-6 max-w-lg mx-auto">
                 <img src="/assets/img/sellos/secure-label.avif" alt="Etiqueta de seguridad VOID evidencia de apertura" class="w-32 h-32 object-contain group-hover:scale-105 transition-transform" loading="lazy">
                 <div>
        ...
        <section id="bancario" class="bg-white py-16 px-8 hover:bg-blue-50 transition-colors group scroll-mt-20">
             <div class="flex items-center gap-6 max-w-lg mx-auto">
                 <img src="/assets/img/sellos/sello-de-seguridad-para-bancos-c-cash.avif" alt="Sello C-CASH bancario para valijas de dinero y traslado de valores" class="w-32 h-32 object-contain group-hover:scale-105 transition-transform" loading="lazy">
                 <div>
    ...
    <!-- GPS TRACKER -->
    <section id="gps" class="py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 scroll-mt-20">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <span class="inline-block bg-emerald-500/20 text-emerald-400 font-bold px-4 py-1 rounded-full text-xs uppercase tracking-wider mb-2">📡 Nuevo Servicio</span>
                <h2 class="text-3xl font-bold text-white">Rastreo GPS y Monitoreo Satelital</h2>
                <p class="text-gray-400 mt-2 max-w-2xl mx-auto">Localiza tu flota en tiempo real. La combinación perfecta: <strong class="text-emerald-400">sellos físicos + rastreo GPS</strong> bajo una misma marca.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
                <!-- Silver -->
                <div class="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-6 text-center hover:border-emerald-500/50 transition-all group">
                    <div class="w-12 h-12 mx-auto bg-gray-600/30 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h4 class="text-white font-bold text-lg mb-1">Silver</h4>
                    <p class="text-gray-400 text-xs mb-3">Rastreo básico</p>
                    <ul class="text-gray-300 text-xs space-y-1 text-left">
                        <li>✓ Ubicación en tiempo real</li>
                        <li>✓ Historial de rutas</li>
                        <li>✓ Alertas de velocidad</li>
                    </ul>
                </div>

                <!-- Gold -->
                <div class="bg-emerald-500/10 backdrop-blur border-2 border-emerald-500/40 rounded-xl p-6 text-center relative transform md:scale-105 shadow-lg shadow-emerald-500/10">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-emerald-500 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Más Popular</div>
                    <div class="w-12 h-12 mx-auto bg-emerald-500/20 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h4 class="text-white font-bold text-lg mb-1">Gold ⭐</h4>
                    <p class="text-emerald-400 text-xs mb-3 font-semibold">Control completo</p>
                    <ul class="text-gray-200 text-xs space-y-1 text-left">
                        <li>✓ Todo de Silver</li>
                        <li>✓ Geocercas ilimitadas</li>
                        <li>✓ Corte de motor remoto</li>
                        <li>✓ Panel web + App móvil</li>
                    </ul>
                </div>

                <!-- Platinum -->
                <div class="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-6 text-center hover:border-emerald-500/50 transition-all group">
                    <div class="w-12 h-12 mx-auto bg-yellow-500/20 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h4 class="text-white font-bold text-lg mb-1">Platinum Star</h4>
                    <p class="text-yellow-400 text-xs mb-3 font-semibold">Máxima seguridad</p>
                    <ul class="text-gray-300 text-xs space-y-1 text-left">
                        <li>✓ Todo de Gold</li>
            ...
            <div class="text-center">
                <a href="/info/producto-gps-tracker" class="inline-flex items-center bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all transform hover:-translate-y-1 shadow-lg hover:shadow-emerald-500/30 group">
                    Ver Planes y Cotizar GPS
                ...
                <p class="text-gray-500 text-xs mt-3">Sin plazo forzoso · Instalación incluida · Cobertura Nacional</p>
            </div>
        </div>
    </section>
...
<script type="application/ld+json">
{
  ...
  "@type": "ItemList",
  "name": "Catálogo de Sellos de Seguridad Control One 2026",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Star One Seal - Sello de Botella ISO 17712", "url": "https://controlone.com.mx/info/producto-sello-botella-star-one" },
    { "@type": "ListItem", "position": 2, "name": "C-ONE 316 - Cable de Acero ISO 17712", "url": "https://controlone.com.mx/info/producto-sello-cable-acero" },
    { "@type": "ListItem", "position": 3, "name": "C-ONE 180 - Cable Galvanizado 3.2mm", "url": "https://controlone.com.mx/info/producto-sello-c-one-180" },
    { "@type": "ListItem", "position": 4, "name": "C-BLOCK - Cable Inoxidable Grado Marino", "url": "https://controlone.com.mx/info/producto-sello-c-block" },
    { "@type": "ListItem", "position": 5, "name": "C-ONE X6 - Cable Fino para Válvulas", "url": "https://controlone.com.mx/info/producto-sello-c-one-x6" },
    { "@type": "ListItem", "position": 6, "name": "C-ONE 116 - Cable Aluminio 1/16", "url": "https://controlone.com.mx/info/producto-sello-c-one-116" },
    { "@type": "ListItem", "position": 7, "name": "Rotaseal - Sello para Medidores", "url": "https://controlone.com.mx/info/producto-sello-rotaseal" },
    { "@type": "ListItem", "position": 8, "name": "Quantum - Precinto Plástico Ajustable", "url": "https://controlone.com.mx/info/producto-precinto-quantum" },
    { "@type": "ListItem", "position": 9, "name": "Quantum R12 - Cintillo Cola de Rata", "url": "https://controlone.com.mx/info/producto-quantum-r12" },
    { "@type": "ListItem", "position": 10, "name": "Alli-One - Sello de Anillo Fijo", "url": "https://controlone.com.mx/info/producto-alli-one" },
    { "@type": "ListItem", "position": 11, "name": "Jumbo Seal - Precinto Paleta Grande", "url": "https://controlone.com.mx/info/producto-jumbo-seal" },
    { "@type": "ListItem", "position": 12, "name": "Etiquetas VOID - Evidencia de Apertura", "url": "https://controlone.com.mx/info/producto-cinta-seguridad-void" },
    { "@type": "ListItem", "position": 13, "name": "C-CASH - Sello Bancario para Valijas", "url": "https://controlone.com.mx/info/producto-sello-c-cash" }
  ]
}
</script>
