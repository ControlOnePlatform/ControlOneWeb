                    ...
                    <form action="enviar.php" method="POST" class="space-y-6">
                        ...
                        <script>
                            ...
                            const catalog = [
                                ...
                                { group: '📡 Rastreo GPS', options: [
                                    { id: 'gps-silver', name: 'GPS Silver (Básico)', min: 1 },
                                    { id: 'gps-gold', name: 'GPS Gold (Completo)', min: 1 },
                                    { id: 'gps-platinum', name: 'GPS Platinum Star (Premium)', min: 1 }
                                ]}
                            ];
...
<script type="application/ld+json">
{
    ...
    "description": "Solicita precios de sellos de seguridad, precintos y rastreo GPS. Envíos a todo México.",
    "mainEntity": {
        "@type": "LocalBusiness",
        "name": "Control One",
