                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="/contacto.php?producto=C-BLOCK+Premium" class="flex-1 bg-gray-900 hover:bg-gray-800 text-white text-center font-bold py-3 px-6 rounded-md shadow-md transition-colors">
                                Cotizar Premium
                            </a>
...
<script type="application/ld+json">
{
  ...
  "offers": {
    "@type": "AggregateOffer",
    "url": "https://controlone.com.mx/info/producto-sello-c-block.php",
    "priceCurrency": "MXN",
