            ...
            <div class="flex flex-col lg:flex-row gap-12 items-start">
                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="prose text-gray-600 mb-8 text-sm leading-relaxed">
                        <p>
                            El precinto <strong>Quantum</strong> destaca por su robustez. A diferencia de los sellos comunes, este modelo incorpora un <strong>inserto de acero (galvanizado o inoxidable)</strong> en la cerradura, lo que proporciona una sujeción firme y previene la manipulación por calor o giro.
                        </p>
                        <ul class="list-disc pl-5 space-y-2 mt-4">
                            <li><strong>Industria Alimentaria:</strong> Fabricado con materiales que no contaminan y resisten grasas y aceites.</li>
                            <li><strong>Máxima Tracción:</strong> Soporta más de <strong>45 kgF</strong>, superior al promedio del mercado.</li>
                            <li><strong>Diseño Anti-Giro:</strong> Incluye entre 3 y 5 picos de retención que se clavan en la bolsa o superficie para evitar deslizamientos.</li>
                            <li><strong>Durabilidad:</strong> No se deforma tras la instalación y resiste temperaturas extremas.</li>
                        </ul>
                    </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                    <h3 class="font-bold text-primary mb-4 border-b pb-2">Composición</h3>
                    <ul class="text-sm text-gray-600 space-y-4">
                        <li class="flex justify-between border-b border-gray-50 pb-2">
                            <span>Cinturón y Tapa:</span> 
                            <strong>Polipropileno (Fluidez 10/20 + Aditivo Antiestático)</strong>
                        </li>
                        <li class="flex justify-between border-b border-gray-50 pb-2">
                            <span>Mecanismo de Bloqueo:</span> 
                            <strong>Inserto de Acero Galvanizado o Inoxidable</strong>
                        </li>
                        <li class="flex justify-between border-b border-gray-50 pb-2">
                            <span>Resistencia a la Tracción:</span> 
                            <strong class="text-accent text-lg">> 45 kgF</strong>
                        </li>
                        <li class="flex justify-between border-b border-gray-50 pb-2">
                            <span>Área de Identificación:</span> 
                            <strong>37 x 15 mm</strong>
                        </li>
                        <li class="flex justify-between pb-2">
                            <span>Personalización:</span> 
                            <strong>Láser alfanumérico, Código de Barras, Logotipo</strong>
                        </li>
                    </ul>
                </div>

                <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                    <h3 class="font-bold text-primary mb-4 border-b pb-2">Dimensiones por Modelo</h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            <thead>
                                <tr class="bg-gray-50 text-gray-700">
                                    <th class="py-2 px-2 text-left">Versión</th>
                                    <th class="py-2 px-2 text-center">Longitud Total</th>
                                    <th class="py-2 px-2 text-center">Longitud Útil</th>
                                    <th class="py-2 px-2 text-center">Ancho Banda</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                <tr>
                                    <td class="py-3 px-2 font-bold text-primary">Quantum 8"</td>
                                    <td class="py-3 px-2 text-center">264 mm</td>
                                    <td class="py-3 px-2 text-center">201 mm</td>
                                    <td class="py-3 px-2 text-center">8 mm</td>
                                </tr>
                                <tr>
                                    <td class="py-3 px-2 font-bold text-primary">Quantum 12"</td>
                                    <td class="py-3 px-2 text-center">352 mm</td>
                                    <td class="py-3 px-2 text-center">291 mm</td>
                                    <td class="py-3 px-2 text-center">8 mm</td>
                                </tr>
                                <tr>
                                    <td class="py-3 px-2 font-bold text-primary">Quantum 16"</td>
                                    <td class="py-3 px-2 text-center">490 mm</td>
                                    <td class="py-3 px-2 text-center">403 mm</td>
                                    <td class="py-3 px-2 text-center">8 mm</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="mt-4 text-xs text-gray-400">
                        * Empaque estándar: Caja con 1,000 piezas (Bolsas de 100 pzs).
                    </div>
                </div>
