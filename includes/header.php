...
<head>
    ...
    fbq('init', '1564745351393194'); 
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1564745351393194&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->

    <!-- LinkedIn Insight Tag -->
    <script type="text/javascript">
    _linkedin_partner_id = "7654321";
    ...
    <noscript>
    <img style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=7654321&fmt=gif" />
    </noscript>
